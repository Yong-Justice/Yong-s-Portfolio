...
export type Project = {
  ...
  next: Record<Locale, string[]>; liveUrl?: string; repositoryUrl?: string; screenshots?: { src: string; alt: LocalText; kind?: "desktop" | "mobile" }[]; repositoryVisibility: "public" | "private" | "not-applicable";
...
export const projects: Project[] = [
  {
    ...
    role: { en: "Digital solution design & web application development", fr: "Conception de solution numérique & développement d’application web" },
    ...
    responsibilities: { en: ["Model case, client, document, deadline, and task information", "Translate operational needs into responsive workflows", "Implement search, filters, tasks, and status patterns", "Consider daily usability, support needs, privacy, and maintainability"], fr: ["Modéliser dossiers, clients, documents, échéances et tâches", "Transformer les besoins opérationnels en workflows responsives", "Implémenter recherche, filtres, tâches et statuts", "Prendre en compte l’usage quotidien, le support, la confidentialité et la maintenance"] },
  ...
  },
  {
    ...
    role: { en: "Digitalisation workflow design & web application development", fr: "Conception de workflow de digitalisation & développement d’application web" },
    ...
    responsibilities: { en: ["Define folder, document, metadata, access, and retention relationships", "Design intake, classification, search, and retrieval workflows", "Represent permission, activity, and retention states", "Build responsive views that reduce document-handling friction"], fr: ["Définir les relations entre dossiers, documents, métadonnées, accès et conservation", "Concevoir acquisition, classement, recherche et récupération", "Représenter permissions, activité et conservation", "Construire des vues responsives qui réduisent la friction documentaire"] },
    ...
    stack: ["Next.js 16", "TypeScript", "Tailwind CSS 4", "Radix UI", "Recharts", "Vercel"],
    ...
    liveUrl: "https://arkiva-eta.vercel.app",
    repositoryUrl: "https://github.com/Yong-Justice/Arkiva",
    screenshots: [
      { src: "/images/projects/arkiva/arkiva-desktop.png", alt: { en: "Arkiva records-management demonstration sign-in screen on desktop", fr: "Écran de connexion de démonstration Arkiva sur ordinateur" } },
      { src: "/images/projects/arkiva/arkiva-mobile.png", alt: { en: "Arkiva responsive demonstration sign-in screen on mobile", fr: "Écran de connexion responsive de démonstration Arkiva sur mobile" } },
    ],
    repositoryVisibility: "public",
  },
  {
    ...
    role: { en: "Web application, workflow & usability contributor", fr: "Contribution application web, workflows & utilisabilité" },
    ...
    constraints: { en: ["Private repository and client confidentiality", "Use only the screenshots explicitly supplied for this portfolio", "Never expose payment, credential, or proprietary exam data"], fr: ["Dépôt privé et confidentialité client", "Utiliser uniquement les captures fournies explicitement pour ce portfolio", "Ne jamais exposer paiements, identifiants ou contenu d’examen propriétaire"] },
    ...
    features: { en: ["Reading, listening, writing, and speaking examination flows", "Timers, audio sequences, corrections, and learner feedback", "User accounts, payments, access plans, and role-based workflows", "Responsive multimedia content and administration support"], fr: ["Parcours d’examen en lecture, écoute, écriture et expression orale", "Minuteurs, séquences audio, corrections et retours apprenant", "Comptes utilisateurs, paiements, plans d’accès et workflows par rôle", "Contenus multimédias responsives et support à l’administration"] },
    stack: ["React", "JavaScript", "Supabase", "SQL", "Multimedia"],
    decisions: { en: [{ title: "Approved evidence only", description: "Present only the interface captures supplied for this portfolio while keeping private implementation details excluded." }, { title: "Skill-specific interaction", description: "Keep each exam mode fit for its task while preserving shared navigation and feedback patterns." }], fr: [{ title: "Preuves approuvées uniquement", description: "Présenter uniquement les captures fournies pour ce portfolio, sans révéler les détails privés de l’implémentation." }, { title: "Interaction selon la compétence", description: "Adapter chaque mode d’examen tout en conservant navigation et retours partagés." }] },
    outcomes: { en: ["Contributed verified web-application, workflow, content-organisation, testing, learner-support, and usability work.", "No ownership, commercial result, or client metric is claimed."], fr: ["Contribution vérifiée à l’application web, aux workflows, à l’organisation des contenus, aux tests, au support apprenant et à l’utilisabilité.", "Aucune propriété, résultat commercial ou métrique client n’est revendiqué."] },
    ...
    next: { en: ["Continue responsive testing across examination workflows", "Add further public evidence only when explicitly supplied or approved"], fr: ["Poursuivre les tests responsives des différents parcours d’examen", "Ajouter d’autres preuves publiques uniquement lorsqu’elles sont fournies ou approuvées explicitement"] },
    screenshots: [
      { src: "/images/projects/german-exam-platform/dashboard.png", kind: "desktop", alt: { en: "Learner dashboard with progress, skill balance, and recent German exam simulations", fr: "Tableau de bord apprenant avec progression, équilibre des compétences et simulations récentes" } },
      { src: "/images/projects/german-exam-platform/catalog.png", kind: "desktop", alt: { en: "German examination catalogue with Goethe, ÖSD, telc, and ECL preparation routes", fr: "Catalogue de préparation aux examens Goethe, ÖSD, telc et ECL" } },
      { src: "/images/projects/german-exam-platform/listening-simulation.png", kind: "desktop", alt: { en: "Goethe B2 listening simulation with timer, audio controls, progress, and question navigation", fr: "Simulation d’écoute Goethe B2 avec minuteur, audio, progression et navigation des questions" } },
      { src: "/images/projects/german-exam-platform/listening-mobile.png", kind: "mobile", alt: { en: "Responsive German listening simulation on a mobile device", fr: "Simulation d’écoute allemande responsive sur mobile" } },
    ],
    repositoryVisibility: "private", confidentiality: { en: "Private repository — client confidentiality", fr: "Dépôt privé — confidentialité client" },
  },
  {
